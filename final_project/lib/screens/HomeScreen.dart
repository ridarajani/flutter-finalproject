                      ...
                      children: [
                        ...
                        Stack(
                          children: [
                            IconButton(
                              onPressed: () {}, 
                              icon: Icon(Icons.notifications, size: 50, color: Color.fromRGBO(233, 216, 63, 1),)
                            ),
                            Positioned(
                              top: 10,
                              right: 0,
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Frequency that someone in the U.S needs blood.',
                        style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  CircleAvatar(
                                    radius: 40,
                                    foregroundColor: Color.fromRGBO(24, 32, 35, 0.5),
                                    child: Icon(Icons.bloodtype, color: Color.fromRGBO(29, 69, 147, 1), size: 50,),
                                  ),
                                  Padding(
                                  ...
                                  Text('Blood donations needed per day.',
                                  style: TextStyle(
                                      color: Color.fromRGBO(24, 32, 35, 0.5),
                                      fontSize: 14,
                                      fontWeight: FontWeight.w400),
                              ...
                              child: Column(
                                children: [
                                  CircleAvatar(
                                    radius: 40,
                                    foregroundColor: Color.fromRGBO(24, 32, 35, 0.5),
                                    child: Icon(Icons.calendar_month, color: Color.fromRGBO(29, 69, 147, 1), size: 50,),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 15, bottom: 8),
                                    child: Text('30M',
                                  ...
                                  Text('Total blood components transferred each year in the U.S.',
                                  style: TextStyle(
                                      color: Color.fromRGBO(24, 32, 35, 0.5),
                                      fontSize: 14,
                                      fontWeight: FontWeight.w400),
