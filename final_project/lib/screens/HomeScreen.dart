        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('Connecting People', style: TextStyle(color: Color.fromRGBO(24, 32, 35, 1), fontSize: 26, fontWeight: FontWeight.w700),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 5, 0, 25),
                child: Text('Please donate if you are somebody’s type!', style: TextStyle(color: Color.fromRGBO(24, 32, 35, 1), fontSize: 15, fontWeight: FontWeight.w300),
                ),
              ),
              Padding(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(color: Color.fromRGBO(24, 32, 35, 1), fontSize: 14, fontWeight: FontWeight.w400),
