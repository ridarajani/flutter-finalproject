...
class DonationsReceived extends StatefulWidget {
  const DonationsReceived({Key? key}) : super(key: key);

  @override
  State<DonationsReceived> createState() => DonationsReceivedState();
}

class DonationsReceivedState extends State<DonationsReceived> {
  @override
